...
package app.simulacra.domaincore.utils.base64

import java.io.ByteArrayOutputStream

/**
 * Wrapper that provides platform-independent utility methods for dealing with Base64 -
 * allows to test code on JVM without unnecessary mocking.
 */
