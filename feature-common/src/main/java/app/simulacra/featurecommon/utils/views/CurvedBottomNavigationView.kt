...
class CurvedBottomNavigationView @JvmOverloads constructor(
    ...
    private var backgroundShapeColor: Int =
        ContextCompat.getColor(getContext(), R.color.almost_black)
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        val firstCurveStartPoint = Point().apply { set(w / 2 - (fabRadius * 1.7).toInt(), 0) }
        val secondCurveEndPoint = Point().apply { set(w / 2 + (fabRadius * 1.7).toInt(), 0) }
